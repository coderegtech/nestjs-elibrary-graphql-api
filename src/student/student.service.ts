...
export class StudentService {
  ...
  async updateOneStudent(id: number, updateStudentInput: UpdateStudentInput): Promise<Student> {
    try {
      return await this.prisma.student.update({ where: { sid: id }, data: { ...updateStudentInput } })
